# Generated by Django 4.1.1 on 2022-09-22 09:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_currently_testing', models.BooleanField(default=False, help_text='States if engineer is currently using test accounts', verbose_name='testing status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='web_app.engineer')),
            ],
        ),
    ]
